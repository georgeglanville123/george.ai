...
COMPANIES = ["1&1 Drillisch", "2degrees", "4iG", "AIS", "Almadar Aljaded (Al Madar)", "Altibox", "Altice", "Altice USA", "America Movil", "AT&T", "AXIAN Telecom", "Axiata", "Batelco", "Bell Canada", "Bezeq", "Bharti Airtel", "BICS", "Bite Group", "Bouygues Telecom", "BSNL", "BT", "Charter Communications", "China Broadnet", "China Mobile", "China Telecom", "China Unicom", "Chunghwa Telecom", "altafiber (CBTS)", "Cirion Technologies", "Citic Telecom CTC", "CK Hutchison", "COLT", "Comcast", "Companhia de Telecomunicacoes de Macau (CTM)", "Cox Communications", "Cyfrowy Polsat Group", "CYTA", "Deutsche Telekom", "Digital Nasional Berhad (DNB)", "DISH Wireless", "Dito Telecommunity", "du", "e& (formerly Etisalat Group)", "Elisa", "Entel", "Ethio Telecom", "FarEasTone", "Globe Telecom", "HKT", "Iliad", "Kazakhtelecom", "KDDI", "KPN", "KT", "Lao Telecommunications Company (LTC)", "LG U+", "Liberty Global", "Liberty Latin America", "Lumen Technologies (formerly CenturyLink)", "Mafab Communications", "MASMOVIL", "Mauritius Telecom", "Maxis", "MegaFon", "MegaPath", "Melita", "Millicom", "Mobile Communication Company of Iran (MCI)", "Mobile TeleSystems (MTS)", "MTN", "ngena", "NOS", "NOW Telecom", "NTT Group", "Omantel", "Ooredoo", "Orange", "Pakistan Telecommunication Co. Ltd (PTCL)", "PLDT", "Polkomtel", "PPF Telecom Group", "Proximus (formerly Belgacom)", "Rain", "Rakuten Mobile", "RCS&RDS", "Reliance Jio", "Retelit", "Rogers Communications", "Safaricom", "Sasktel", "stc", "SES", "Sify Technologies", "Silknet", "Singtel", "SK Telecom", "SLT-Mobitel", "SmarTone", "SoftBank", "Spark New Zealand", "Sprint", "StarHub", "Sunrise Communications", "Swisscom", "Taiwan Mobile", "TalkTalk", "Tata Communications", "Tcell", "TDC", "Tele2", "Telecom Argentina", "Telecom Egypt", "TIM", "Telefónica", "A1 Telekom Austria", "Telekom Malaysia", "Telekom Slovenije", "Telekom Srbija", "Telenet", "Telenor", "Telia", "Telkom (South Africa)", "Telkom Indonesia", "Telstra", "Telus", "TIME dotCom", "TPG Telecom", "TPx Communications", "True Corp.", "Turk Telekom", "Turkcell", "Ucell", "Unified National Networks (UNN)", "United Group", "Unitel", "US Cellular", "Uzbektelecom", "Veon (formerly VimpelCom)", "Verizon", "Videotron", "Viettel", "Virgin Media O2", "Vivacom", "Vocus Group", "Vodafone", "VodafoneZiggo", "Vonage", "Wind Tre", "Windstream", "WOM", "Yettel", "YTL Communications", "Zain", "Zayo", "T-Mobile US", "Vodacom", "Telkomsel", "XL Axiata", "Indosat Ooredoo Hutchison", "TIM Brasil", "Vivo (Telefônica Brasil)", "Claro", "Mobily", "Airtel Africa", "Jazz", "Grameenphone", "Robi Axiata"]
...
def cap_by_domain(items, per_domain=2):
    """Optional: keep at most N items per hostname to avoid 10 near-identical rewrites."""
    counts, out = {}, []
    for it in items:
...
# choose the best candidates to fetch
ranked = sorted(
    all_results,
    key=lambda it: (score_item(it), len(it.get("title",""))),  # len(title) is a tiny tie-breaker
    reverse=True
)
...
def fetch_and_extract(url: str, client: httpx.Client,
    ...
    if url.lower().endswith(BINARY_EXTS):
        return {
            "url": url, "text": None, "title": None, "date": None,
            "error": "skipped_binary"
        }
...
def run_pipeline():
    ...
    # 1) Build & Search
    queries = build_queries()  # returns List[Tuple[query, company]]
    ...
    # Rank and pick the best to fetch
    ranked = sorted(
        all_results,
        key=lambda it: (score_item(it), len(it.get("title",""))),  # tiny tie-breaker
        reverse=True
    )
    candidates = cap_by_domain(ranked, per_domain=2)[:MAX_FETCH]
